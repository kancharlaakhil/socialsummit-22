    ...
    return (
        <div className='row add-new-event-container'>
            ...
            <div className='col-8 event-specific-registration-form h-100'>
                <RegistrationForm eventsList={eventsList} selectedIndex={selectedIndex} setParticipantDetails={setParticipantDetails}  appendTeamMembers={appendTeamMembers} setLeader={setLeader} changeTeamName={changeTeamName} />
            </div>
        </div>
    )
}
